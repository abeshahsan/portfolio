...
export default function Footer() {
	return (
		<footer className='border-t border-slate-200/70 bg-white/70 py-10 text-sm text-slate-500 backdrop-blur dark:border-slate-800/70 dark:bg-slate-950/60'>
			<div className='mx-auto flex max-w-6xl flex-col items-center gap-6 px-6'>
				...
				<p className='flex items-center gap-2 text-slate-600 dark:text-slate-400'>
					Built with <FiHeart className='h-4 w-4 text-rose-500' /> by Abesh Ahsan &copy; {new Date().getFullYear()}
				</p>
			</div>
		</footer>
	);
